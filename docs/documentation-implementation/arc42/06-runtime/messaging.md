...
(cf. [`backend/src/realtime/socket.ts`](https://github.com/Sojeremy/documentation-skillswap/blob/main/backend/src/realtime/socket.ts)).
...
[`backend/src/routers/conv.router.ts`](https://github.com/Sojeremy/documentation-skillswap/blob/main/backend/src/routers/conv.router.ts).
...
[`useMessaging`](https://github.com/Sojeremy/documentation-skillswap/blob/main/frontend/src/hooks/useMessaging.ts)
...
([`hooks/useSocket.ts`](https://github.com/Sojeremy/documentation-skillswap/blob/main/frontend/src/hooks/useSocket.ts), 136 LOC) gère :
...
[`useConversationActions.ts:100-118`](https://github.com/Sojeremy/documentation-skillswap/blob/main/frontend/src/hooks/messaging/useConversationActions.ts))
